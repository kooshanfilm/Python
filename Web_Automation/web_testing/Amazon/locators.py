...
class L1patients(object):
    first_patient = "//*[@id='igx-grid-2']/div[2]/div[1]/igx-display-container/igx-grid-row[1]/igx-display-container/igx-grid-cell[1]"
    patient_details_btn = '/html/body/app-root/div/div/div[2]/div[2]/ng-component/div[1]/div/div/div/div[1]/div[2]/div[2]/button'
